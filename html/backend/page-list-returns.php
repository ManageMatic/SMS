...
if (isset ($_SESSION['login_user'])) {
    ...
    $sql = "SELECT * FROM returns WHERE UID = ?";
...
<head>
    ...
    <title>Returns List | ManageMatic | Store Management System</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                            ...
                            <a href="page-add-return.php" class="btn btn-primary add-list"><i
                            ...
                            <table class="data-table table mb-0 tbl-server-info">
                                ...
                                if (!empty ($data)) {
                                    ...
                                    foreach ($data as $row) {
                                        ...
                                        echo '<td>' . $row['RBILLER'] . '</td>';
                                        echo '<td>' . $row['RPRODUCT'] . '</td>';
                                        echo '<td>' . $row['RCUSTOMER'] . '</td>';
                                        echo '<td>' . $row['RTOTAL'] . '</td>';
                                        echo '<td>';
