...
<head>
    ...
    <title>Customers List | ManageMatic | Store Management System</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                            ...
                            <a href="page-add-customers.php" class="btn btn-primary add-list"><i
                            ...
                            <table class="data-table table mb-0 tbl-server-info">
                                ...
                                if(!empty($data)){
                                    ...
                                    foreach($data as $row){
                                        ...
                                        echo '</div>';
                                        echo '</td>';
                                        echo '<td>' . $row['CSTNAME'] . '</td>';
                                        echo '<td>' . $row['CSTEMAIL'] . '</td>';
                                        echo '<td>' . $row['CSTNUM'] . '</td>';
                                        echo '<td>' . $row['CSTADDRESS'] . '</td>';
                                        echo '<td>' . $row['CSTCITY'] . '</td>';
                                        echo '<td>' . $row['CSTSTATE'] . '</td>';
                                        echo '<td>';
