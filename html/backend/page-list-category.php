...
<head>
    ...
    <title>Category List | ManageMatic | Store Management System</title>
                            ...
                            <table class="data-tables table mb-0 tbl-server-info">
                                ...
                                if (!empty($data)) {
                                    ...
                                    foreach ($data as $row) {
                                        ...
                                        //echo '<img src="' . $row['CIMAGE'] . '" class="img-fluid rounded avatar-50 mr-3" alt="image">';
                                        //echo '<div>';
                                        echo $row['CPNAME'];
                                        echo '</div>';
                                        echo '</div>';
                                        echo '</td>';
                                        echo '<td>' . $row['CCODE'] . '</td>'; // Product code displayed here
