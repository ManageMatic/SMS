...
if (isset($_POST['submitSignup'])) {
   ...
   if ($password !== $confirm_password) {
      ...
      // Check if Store Name or Email is already registered
                           ...
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 ...
                                 <form action="" method="post">
                                    <div class="row">
                                       <div class="col-lg-6">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="signupSname"
                                                id="signupSname" type="text" required>
                                             <label>Full Name</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="signupSTname"
                                                id="signupSTname" type="text" required>
                                             <label>Store Name</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="signupEmail"
                                       ...
                                       <div class="col-lg-6">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="signupPhone"
                                                id="signupPhone" type="text" required>
                                             <label>Phone No.</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="signupSpass"
                                                id="signupSpass" type="password" required>
                                             <label>Password</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" name="signupSCpass"
                                                id="signupSCpass" type="password" required>
                                    ...
                                    <p class="mt-3">
                                       Already have an Account <a href="auth-sign-in.php" class="text-primary">Sign
                                          In</a>
                                    </p>
                                 </form>
                              </div>
